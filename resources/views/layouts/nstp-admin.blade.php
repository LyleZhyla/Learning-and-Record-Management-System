    ...
    <div class="app-shell">
        <aside class="sidebar nstp-sidebar" id="sidebar">
            ...
            <nav class="main-nav" aria-label="NSTP Admin navigation">
                ...
                <a class="nav-link {{ request()->routeIs('nstp_admin.components.*', 'nstp_admin.sections.*', 'nstp_admin.sectioning.*') ? 'active' : '' }}" href="{{ route('nstp_admin.sections.index') }}"><span class="nav-icon">▦</span> Sectioning</a>
