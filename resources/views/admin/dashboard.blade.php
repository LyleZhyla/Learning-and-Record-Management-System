...
@section('content')
    ...
    <section class="metric-grid" aria-label="System overview">
        ...
        <article class="metric-card"><span class="metric-icon orange">▤</span><div><small>Total users</small><strong>{{ $userCount }}</strong><p>Across five account roles</p></div></article>
