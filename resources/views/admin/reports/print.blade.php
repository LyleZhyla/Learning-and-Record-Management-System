...
<body>
    ...
    <header class="report-header"><div class="brand"><img class="print-brand-logo" src="{{ asset('images/smart-nstp-logo-160.png') }}" alt="Smart NSTP logo"><span><strong>Smart NSTP</strong><small>Management and AI-Integrated Platform</small></span></div><div><h1>{{ $report['title'] }}</h1><p>Generated {{ $report['generated_at']->format('F d, Y · h:i A') }}</p></div></header>
