...
<body>
    ...
    <header class="report-header"><div class="brand"><span class="brand-mark">SN</span><span><strong>Smart NSTP</strong><small>Management and AI-Integrated Platform</small></span></div><div><h1>{{ $report['title'] }}</h1><p>Generated {{ $report['generated_at']->format('F d, Y · h:i A') }}</p></div></header>
