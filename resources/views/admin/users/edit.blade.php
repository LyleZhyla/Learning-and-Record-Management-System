        ...
        <div class="side-stack">
            ...
            @if($user->canBePermanentlyDeleted())
                <section class="card danger-zone-card">
                    <div class="card-heading"><div><span class="eyebrow">Danger zone</span><h3>Delete account</h3><p>Permanently removes this {{ strtolower($user->roleLabel()) }} account. Existing institutional content created by staff will be preserved under your account.</p></div></div>
                    <a class="danger-button" href="{{ route('admin.users.delete', $user) }}">Delete account permanently</a>
                </section>
            @endif
        </div>
    </div>
