...
@section('content')
<section class="welcome-banner"><div><span class="eyebrow">Student learning portal</span><h2>Welcome, {{ auth()->user()->name }}.</h2><p>
